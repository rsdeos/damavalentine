...
const CONFIG = {
    ...
    questions: {
        first: {
            ...
            yesBtn: "YES I DO",                                             // Text for "Yes" button
            noBtn: "no bitch",                                               // Text for "No" button
            secretAnswer: "I dont js want you, i need you ❤️"           // Secret hover message
        },
        second: {
        ...
        third: {
            text: "Will you be my Valentine DAMARIS!?!?! 🌹", // The big question!
    ...
    loveMessages: {
        extreme: "WOOOOW YOU LOVE ME LIKE THAT!?!?!",  // Shows when they go past 5000%
        high: "higher.",              // Shows when they go past 1000%
    ...
    music: {
        ...
        musicUrl: "https://res.cloudinary.com/dpkf3fzwm/video/upload/v1739252698/youtube_3w17b0ssInQ_audio_zkc3hw.mp3", // Music streaming URL
